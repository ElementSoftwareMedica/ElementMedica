...
const TEMPLATE_TYPES = [
  { value: 'CERTIFICATE', label: 'Attestato', icon: '📜' },
  { value: 'LETTER', label: 'Lettera', icon: '📄' },
  { value: 'SLIDES', label: 'Presentazione', icon: '📊' }
];
...
const TemplatesSettingsPage: React.FC = () => {
  ...
  const stats = {
    ...
    letter: templates.filter(t => t.type === 'LETTER').length,
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Totale Template</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Attestati</p>
              <p className="text-2xl font-bold text-gray-900 mt-1">{stats.certificate}</p>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Lettere</p>
              <p className="text-2xl font-bold text-gray-900 mt-1">{stats.letter}</p>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Presentazioni</p>
              <p className="text-2xl font-bold text-gray-900 mt-1">{stats.slides}</p>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="md:w-64">
            ...
            >
              ...
              <option value="CERTIFICATE">Attestati</option>
              <option value="LETTER">Lettere</option>
              <option value="SLIDES">Presentazioni</option>
            </select>
          </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-800">
                  ...
                  il contenuto nell'editor visuale e aggiungere placeholders personalizzati.
                </p>
              </div>
            </div>
