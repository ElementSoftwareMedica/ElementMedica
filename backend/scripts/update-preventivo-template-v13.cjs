/**
 * Script per aggiornare il template PREVENTIVO alla versione v13
 * PERFETTO: Replica ESATTA dello screenshot fornito
 * 
 * Caratteristiche v13:
 * - Layout ESATTO come da screenshot
 * - Font compatto per single-page
 * - Colori corretti (#2563eb blue, #1e3a5f dark blue header)
 * - Box con sfumature e ombre leggere
 * - Tabella con header dark blue
 * - Totali con sconto giallo/oro
 * - Footer firma tratteggiato
 * - NO header/footer Puppeteer - tutto nel body
 */
const { PrismaClient } = require('@prisma/client');
const prisma = new PrismaClient();

const TEMPLATE_V13 = `<!DOCTYPE html>
<html lang="it">
<head>
  <meta charset="UTF-8">
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* HEADER - Logo a sinistra, info azienda a destra */
    .header {
      display: flex;
    ...
    /* TITOLO PREVENTIVO - Barra blu con gradiente */
    .doc-title {
...
async function updateTemplates() {
    console.log('🔄 Aggiornamento template PREVENTIVO a v13 (perfezione)...\n');
    ...
    try {
        ...
        for (const template of templates) {
            ...
            await prisma.templateLink.update({
                ...
                data: {
                    content: TEMPLATE_V13,
                    version: 13,
                    updatedAt: new Date()
                }
            });

            console.log('  ✅ Template aggiornato a v13');
        }

        console.log('\n✅ Aggiornamento completato!');
        console.log('\nCaratteristiche v13:');
        console.log('  • Layout compatto single-page');
        console.log('  • Font 9pt per corpo, 7-8pt per label');
        console.log('  • Margini @page 8mm');
        console.log('  • Header con border-bottom blu');
        console.log('  • Titolo gradiente blu (#2563eb)');
        console.log('  • Info box con sfumatura grigio chiaro');
        console.log('  • Service box azzurro');
        console.log('  • Tabella header dark blue (#1e3a5f)');
        console.log('  • Totali con sconto giallo');
        console.log('  • Note box giallo/oro');
        console.log('  • Firma tratteggiata azzurra');
