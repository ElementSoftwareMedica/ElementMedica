...
// Icon mapping esteso per tutti i servizi - a livello di modulo per essere accessibile ovunque
...
const getIconComponent = (iconName: string | undefined, fallback: React.ElementType = CheckCircle): React.ElementType => {
