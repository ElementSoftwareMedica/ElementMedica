...
router.get('/',
  authenticate,
  requirePermissions(['read:codici_sconto']),
  [
...
router.post('/',
  authenticate,
  requirePermissions(['create:codici_sconto']),
  ...
  [
    ...
    body('descrizione').optional().isString().isLength({ max: 1000 }),
    ...
    body('utilizzoMassimo').optional().isInt({ min: 1 }).toInt(),
    body('utilizzoPerUtente').optional().isInt({ min: 1 }).toInt(),
...
router.put('/:id',
  authenticate,
  requirePermissions(['update:codici_sconto']),
...
router.delete('/:id',
  authenticate,
  requirePermissions(['delete:codici_sconto']),
