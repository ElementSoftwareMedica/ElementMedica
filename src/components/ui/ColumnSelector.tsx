...
export const ColumnSelector: React.FC<ColumnSelectorProps> = ({
  ...
  return (
    <div className={`relative ${className}`} ref={ref}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-md shadow-lg dark:shadow-black/30 z-50 border border-gray-200 dark:border-gray-700">
          <div className="p-3 text-sm font-medium text-blue-700 dark:text-blue-300 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-t-md">
            Gestisci colonne
          </div>

          <div className="p-2 max-h-[400px] overflow-y-auto">
            <div className="flex items-center justify-between mb-2 px-2 py-1 text-xs text-gray-500 dark:text-gray-400">
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      ${column.required ? 'opacity-75' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}
                      ${draggedColumn === column.key ? 'bg-blue-100 dark:bg-blue-900/40' : ''}
                      ${dragOverColumn === column.key ? 'border border-blue-500 bg-blue-50 dark:bg-blue-900/30' : ''}
                    `}
                    draggable={true}
                  ...
                  >
                    <label className="flex items-center gap-2 flex-1 cursor-pointer select-none text-gray-900 dark:text-gray-100">
                      <input
                        type="checkbox"
          ...
          <div className="p-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/80 flex items-center justify-between rounded-b-md">
            <button
