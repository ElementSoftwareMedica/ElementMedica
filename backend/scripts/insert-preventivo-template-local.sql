...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: "Segoe UI", Arial, sans-serif; font-size: 11pt; line-height: 1.6; color: #333; padding: 40px 50px; }
    .header { border-bottom: 3px solid #2563eb; padding-bottom: 20px; margin-bottom: 30px; }
    .header h1 { color: #2563eb; font-size: 28pt; font-weight: 600; margin-bottom: 10px; }
    .header .subtitle { font-size: 12pt; color: #666; }
    .section { margin-bottom: 25px; }
    .section-title { font-size: 14pt; font-weight: 600; color: #1e40af; margin-bottom: 12px; border-bottom: 2px solid #e5e7eb; padding-bottom: 6px; }
    .info-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; margin-bottom: 15px; }
    .info-item { display: flex; flex-direction: column; }
    .info-label { font-weight: 600; color: #666; font-size: 9pt; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px; }
    .info-value { font-size: 11pt; color: #111; }
    .price-table { width: 100%; border-collapse: collapse; margin: 15px 0; background: white; }
    .price-table thead { background: #f3f4f6; }
    .price-table th { padding: 12px; text-align: left; font-weight: 600; font-size: 10pt; color: #374151; border-bottom: 2px solid #d1d5db; }
    .price-table td { padding: 10px 12px; border-bottom: 1px solid #e5e7eb; font-size: 11pt; }
    .price-table td.label { font-weight: 500; color: #4b5563; }
    .price-table td.value { text-align: right; font-family: "Courier New", monospace; }
    .price-table tr.subtotal td { border-top: 1px solid #d1d5db; padding-top: 15px; font-weight: 600; }
    .price-table tr.discount td { color: #059669; }
    .price-table tr.total { background: #eff6ff; font-weight: 700; font-size: 13pt; }
    .price-table tr.total td { border-top: 3px solid #2563eb; border-bottom: 3px solid #2563eb; padding: 15px 12px; }
    .notes-box { background: #fffbeb; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0; border-radius: 4px; }
    .notes-title { font-weight: 600; color: #92400e; margin-bottom: 8px; font-size: 11pt; }
    .notes-content { color: #78350f; font-size: 10pt; line-height: 1.5; white-space: pre-wrap; }
    .footer { margin-top: 40px; padding-top: 20px; border-top: 2px solid #e5e7eb; font-size: 9pt; color: #6b7280; }
    .footer-section { margin-bottom: 12px; }
    .footer-title { font-weight: 600; color: #374151; margin-bottom: 6px; }
