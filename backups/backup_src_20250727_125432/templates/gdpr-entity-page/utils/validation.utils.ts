...
export interface ValidationRule {
  ...
  max?: number;
  pattern?: RegExp;
  customValidator?: (value: any, entity: any) => string | null;
  dependsOn?: string[];
  conditional?: (entity: any) => boolean;
}
...
export class ValidationUtils {
   ...
   */
  private static findUnknownFields(obj: any, knownFields: Set<string>): string[] {
    ...
    return {
      ...
      codiceFiscale: {
        ...
        customValidator: (value) => {
          ...
          return value.length === 16 ? null : 'Codice fiscale deve essere di 16 caratteri';
        }
      },
      ...
      partitaIva: {
        ...
        customValidator: (value) => {
          ...
          if (value.length !== 11) return 'Partita IVA deve essere di 11 cifre';
          ...
          return checkDigit === parseInt(value[10]) ? null : 'Partita IVA non valida';
        }
      },
      ...
      status: {
        ...
        customValidator: (value) => {
          ...
          return validStatuses.includes(value) ? null : `Status deve essere uno di: ${validStatuses.join(', ')}`;
        }
      },
