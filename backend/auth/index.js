...
export function createAuthRouter() {
    ...
    // CORS configuration
    // Build dynamic CORS allowed origins (locale + produzione)
    ...
    const AUTH_ALLOWED_ORIGINS = Array.from(new Set([...defaultAllowedOrigins, ...envAllowedOrigins]));
    router.use(cors({
        origin: AUTH_ALLOWED_ORIGINS,
        credentials: true,
...
export async function initializeAuth() {
    try {
        ...
        // Clean up expired sessions on startup (resilient if table missing)
        try {
