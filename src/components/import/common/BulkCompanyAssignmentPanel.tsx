...
const BulkCompanyAssignmentPanel: React.FC<BulkCompanyAssignmentPanelProps> = ({
  ...
  return (
    <div className="mt-4 border border-blue-300 bg-blue-50 rounded-lg p-4">
      ...
      <div className="bg-white rounded-lg p-3 border border-blue-200">
        ...
        <div className="relative">
          <button
            ...
            className="w-full flex items-center justify-between px-6 py-2.5 border border-gray-300 rounded-full bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
          >
            <span className="text-sm">
              {selectedOption ? (
                <span className="font-medium">{selectedOption.displayText}</span>
              ) : (
                <span className="text-gray-400">Seleziona azienda e sede...</span>
              )}
            </span>
          ...
          {isOpen && (
            <div className="absolute z-10 w-full mt-2 bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-3 border-b border-gray-200 bg-gray-50">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div className="max-h-60 overflow-y-auto">
                ...
                >
                  <span className="text-gray-500 italic">Nessuna assegnazione</span>
                </button>
                ...
                {filteredOptions.length === 0 ? (
                  ...
                  filteredOptions.map((option, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="font-medium">{option.displayText}</div>
