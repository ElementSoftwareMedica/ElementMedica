 ...
 * 
 * Usa ThemeContext come source of truth per il tema.
 */
...
import { useTheme, ThemeMode, ThemeColor } from '../../context/ThemeContext';
...
export const ThemeSelector: React.FC<ThemeSelectorProps> = ({ className }) => {
  const { mode, themeColor, isDark, setMode, setThemeColor } = useTheme();
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              <strong>Tema corrente:</strong> {THEME_OPTIONS.find(o => o.mode === mode)?.label}
              {mode === 'auto' && (
                <span className="ml-1">
