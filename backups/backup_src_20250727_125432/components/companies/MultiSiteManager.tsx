...
import SopralluogoManager from '../SopralluogoManager';
import RepartoManager from '../RepartoManager';
...
const MultiSiteManager: React.FC<MultiSiteManagerProps> = ({ companyId, companyName }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch sites
      const sitesResponse = await apiGet(`/api/company-sites/company/${companyId}`) as { sites: CompanySite[] };
