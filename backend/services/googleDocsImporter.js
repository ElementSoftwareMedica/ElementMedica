 ...
 * Fetches Google Docs documents and converts them to HTML for template editor
 */
...
async function fetchDocument(documentId, accessToken) {
  try {
    ...
    logger.info('Google Docs document fetched successfully', {
    ...
    logger.error('Failed to fetch Google Docs document', {
      component: 'googleDocsImporter',
      action: 'fetchDocument',
      documentId,
      error: error.message,
